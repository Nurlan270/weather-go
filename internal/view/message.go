...
const (
	...
	MessageUserAlreadyExists = "User with provided login already exists"
	MessageUserNotFound      = "User with provided login doesn't exists"
	MessageInvalidPassword   = "Provided password is invalid"
)
